<template>
  <section class="py-20 bg-gradient-to-r from-primary to-blue-600 text-white stats-section">
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div class="text-center">
          <div class="text-4xl md:text-5xl font-bold mb-2" :class="{ 'animate-pulse': isVisible }">
      ...
      <div class="mt-16 grid md:grid-cols-3 gap-8 text-center">
        ...
        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6">
          <Icon name="lucide:shield" class="w-12 h-12 mx-auto mb-4 opacity-90" />
          <h3 class="text-xl font-semibold mb-2">Πλήρης Ασφάλεια</h3>
          <p class="opacity-80">Κρυπτογραφημένες συναλλαγές και προστασία δεδομένων</p>
        </div>
      </div>
    </div>
  </section>
